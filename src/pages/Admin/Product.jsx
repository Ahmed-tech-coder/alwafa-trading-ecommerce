...
const Products = () => {
  ...
  const fetchProducts = () => {
    axios
      .get("https://elwafastore.premiumasp.net/api/Product/GetAll")
      .then((res) => {
  ...
  const handleConfirmDeleteDiscount = () => {
    ...
    axios
      .delete(
        `https://elwafastore.premiumasp.net/api/Product?Id=${selectedProduct.id}`
      )
      .then(() => {
        ...
        <table className="w-full border-collapse text-center min-w-[800px]">
          <thead>
            ...
            >
              ...
              <th className="py-3 px-4 border-r whitespace-nowrap">Name</th>
              <th className="py-3 px-4 border-r whitespace-nowrap">Quantity</th>
              <th className="py-3 px-4 border-r whitespace-nowrap">Width</th>
              <th className="py-3 px-4 border-r whitespace-nowrap">Length</th>
          ...
          <tbody>
            {filteredProducts.map((p, idx) => (
              ...
              >
                ...
                <td className="py-3 px-4 border-r">{p.quantity}</td>
                <td className="py-3 px-4 border-r">{p.width}</td>
                <td className="py-3 px-4 border-r">{p.length}</td>
                <td className="py-3 px-4 border-r">{p.thickness}</td>
